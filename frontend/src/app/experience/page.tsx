...
export default function TimelinePage() {
  ...
  if (!resume) {
    return (
      <div className="text-center text-gray-400 dark:text-gray-500 py-24">Failed to load timeline.</div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10">
      <div className="mb-10">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Career Timeline</h1>
              ...
              <div key={i} className="relative pl-16">
                ...
                >
                  {isWork
                    ...
                    : <GraduationCap className="w-2.5 h-2.5 text-gray-400 dark:text-gray-500" />
                  }
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
                  ...
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div>
                      ...
                      <div className="text-sm text-violet-600 dark:text-violet-400 font-medium mt-0.5">
                        {isWork ? work!.company : edu!.institution}
                      </div>
                    </div>
                    <div className="text-right shrink-0">
                      <div className="text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-2.5 py-1 rounded-md whitespace-nowrap">
                        {isWork ? work!.period : edu!.period}
                      </div>
                      {isWork && (
                        <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">{work!.location}</div>
                      )}
                    </div>
                  </div>
